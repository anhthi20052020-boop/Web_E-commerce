...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['register'])) {
    ...
    try {
        // Kiem tra user hay mail da ton tai chua
...
// Lay sp hot sale
$hotSaleSql = "SELECT * FROM products WHERE is_hot = 1 LIMIT 8";
$hotSaleStmt = $pdo->prepare($hotSaleSql);
$hotSaleStmt->execute();
$hotSaleProducts = $hotSaleStmt->fetchAll();

// Lay san pham hot seller
$hotSellerSql = "SELECT * FROM products WHERE is_bestseller = 1 LIMIT 7";
$hotSellerStmt = $pdo->prepare($hotSellerSql);
$hotSellerStmt->execute();
                    ...
                    <?php if (isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in']): ?>
                        <div class="user-dropdown">
                            ...
                            <div class="user-dropdown-content">
                                ...
                                <a href="store.php?logout=1">Logout</a>
                            </div>
                        </div>
    ...
    <div id="overlei" class="overlei">
        <div id="id01" class="wrapper">
            <div class="form-box login">
                <form class="animate" action="store.php" method="post">
                    <h2>Login</h2>
                    <div class="btclose">
...
<!-- BRAND -->
        <section class="brand">
            <h2 class="brand-title">Top Brand</h2>
            <div class="brand-content">
                <ul class="brand-list">
                    <li class="brand-item card">
                        <img src="../uploads/apple.png" alt="Apple">
                    </li>
                    <li class="brand-item card">
                        <img src="../uploads/Samsung.png" alt="Samsung">
                    </li>
                    <li class="brand-item card">
                        <img src="../uploads/Lenovo.png" alt="Lenovo">
                    </li>
                    <li class="brand-item card">
                        <img src="../uploads/Dell.png" alt="Dell">
                    </li>
                    <li class="brand-item card">
                        <img src="../uploads/msi.png" alt="MSI">
                    </li>
                    <li class="brand-item card">
                        <img src="../uploads/asus.png" alt="Asus">
                    </li>
                    <li class="brand-item card">
                        <img src="../uploads/hp.png" alt="HP">
                    </li>
                    <li class="brand-item card">
                        <img src="../uploads/OPPO.png" alt="Oppo">
                    </li>
                    <li class="brand-item card">
                        <img src="../uploads/vivo.png" alt="Vivo">
                    </li>
                    
                    <li class="brand-item card">
                        <img src="../uploads/canon.png" alt="Canon">
                    </li>
                    <li class="brand-item card">
                        <img src="../uploads/sony.png" alt="Sony">
                    </li>
                    <li class="brand-item card">
                        <img src="../uploads/panasonic.png" alt="Panasonic">
                    </li>
                </ul>
            </div>
        </section>
            ...
            <section class="hot-sale">
                <div class="sale-header">
                    ...
                    <div class="countdown">
                        ...
                        <h2 id="countdown-days">02</h2>:<h2 id="countdown-hours">06</h2>:<h2 id="countdown-minutes">49</h2>:<h2 id="countdown-seconds">31</h2>
                    </div>
                </div>

                <div class="products-grid">
                    <?php foreach ($hotSaleProducts as $product): ?>
                    <div class="product-sale" data-id="<?= $product['id'] ?>">
                        <div class="tag">
                            <span class="discount-tag"><?= round(($product['original_price'] - $product['price']) / $product['original_price'] * 100) ?>% OFF</span>
                            <span class="installment-tag">0% Int</span>
                        </div>
    ...
    <h2 class="brand-title">New Product</h2>
    <section class="productbox">
    
    <?php 
    $limitedProducts = array_slice($products, 0, 10);
    foreach ($limitedProducts as $product): ?>
    <div class="product-card">
        <div class="product-tags">
            <span class="tags discount-tags">-<?= round(($product['original_price'] - $product['price']) / $product['original_price'] * 100) ?>%</span>
        ...
        <div class="product-info-container">
            <div class="product-info">
                ...
                <button class="add-to-cart" onclick="addtocart(<?= $product['id'] ?>)">ADD TO CART <span class="cart-icon"><i class="uil uil-shopping-cart"></i></span></button>
            </div>
        </div>
    </div>
    <?php endforeach; ?>
        ...
        <div class="show-all-container">
                <a href="filter.php" class="show-all-button"><i class="fas fa-chevron-down"></i>
                </a>
        </div>
        ...
        <body data-user-logged-in="<?= isset($_SESSION['user_logged_in']) ? 'true' : 'false' ?>" 
      data-user-id="<?= isset($_SESSION['user_id']) ? $_SESSION['user_id'] : '' ?>">

        <!-- MARQUEE CARD -->
       <div class="mar-container">
            <h2 class="mar-title">Hot Seller</h2>
            <section class="featured-products">
                <div class="featured-products-list-container">
                    <ul class="featured-products-list">
                        <?php foreach ($hotSellerProducts as $product): ?>
                        <li class="product-mar">
                            <a href="product.php?id=<?= $product['id'] ?>">
                            <div class="product-mar-img">
                                <img draggable="false" src="<?= $product['image'] ?>" alt="<?= htmlspecialchars($product['name']) ?>" />
                            </div>
                        </a>
                            <div class="product-mar-details">
                                <div class="product-mar-details-container">
                                <a href="product.php?id=<?= $product['id'] ?>">
                                    <p class="product-mar-details-name"><?= htmlspecialchars($product['name']) ?></p>
                                </a>
                                    <div class="mar-prices">
                                        <span class="mar-new-price"><?= number_format($product['price'], 0, ',', '.') ?>đ</span>
                                        <span class="mar-old-price"><?= number_format($product['original_price'], 0, ',', '.') ?>đ</span>
                                    </div>
                                </div>
                            </div>
                        </li>
