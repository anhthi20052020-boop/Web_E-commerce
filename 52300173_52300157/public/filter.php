...
if (!empty($search)) {
    ...
    $sql .= " AND brand = ?";
    $params[] = $brand;
    $pageTitle = "Products by brand: $brand";
}
...
<head>
    ...
    <title><?= htmlspecialchars($pageTitle ?? 'Filter Products') ?> - Atait</title>
...
<body>
                    ...
                    <?php if (isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in']): ?>
                        <div class="user-dropdown">
                            ...
                            <div class="user-dropdown-content">
                                ...
                                <a href="filter.php?logout=1">Logout</a>
                            </div>
                        </div>
        ...
        <div id="overlei" class="overlei">
            <div id="id01" class="wrapper">
                <div class="form-box login">
                    <form class="animate" action="filter.php" method="post">
                        <h2>Login</h2>
                        <div class="btclose">
    ...
    <main>
    <script>
        const productsData = <?php echo json_encode($filteredProducts); ?>;
        window.items = {};
        productsData.forEach(product => {
            window.items[product.id] = {
                id: product.id,
                name: product.name,
                image: product.image,
                star: 5,
        ...
        <section class="filter-results"  style="margin-top: 200px; text-align: center; font-size:24px;">
            <h1><?= htmlspecialchars($pageTitle ?? 'All Products') ?></h1>
            
                <?php if (empty($filteredProducts)): ?>
                    <p class="no-results" style=" text-align: center; font-size:24px;">No products found matching your criteria.</p>
                <?php else: ?>
